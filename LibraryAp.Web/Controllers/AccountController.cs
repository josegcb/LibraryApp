...
using LibraryAp.Sessions;
using LibraryAp.Web.Controllers.Results;
using LibraryAp.Web.Models;
using LibraryAp.Web.Models.Account;
...
{
    public class AccountController : LibraryApControllerBase
    {
        ...
        public virtual async Task<ActionResult> Register(RegisterViewModel model)
        {
            try
            {
                ...
                _unitOfWorkManager.Current.SetFilterParameter(DataFilters.MustHaveAgency, DataFilters.MustHaveAgencyParam, AbpSession.GetAgenciaId());
