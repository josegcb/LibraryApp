    ...
    angular.module('app').controller(controllerId, [
        ...
        function ($rootScope, $state, appSession) {
            ...
            vm.menuItems = [
                ...
                createMenuItem(App.localize("Tenants"), "", "business", "tenants"),
                createMenuItem(App.localize("Users"), "", "people", "users"),
                createMenuItem(App.localize("Roles"), "", "local_offer", "roles"),
                createMenuItem(App.localize("About"), "", "info", "about"),
                createMenuItem(App.localize("Agencias"), "", "business", "agencias"),
                createMenuItem(App.localize("Cajas"), "", "business", "cajas"),
